...
@section('content')
    <div style="text-align: center; margin-top: 30px;">
        ...
        <form action="{{ route('restaurant.store') }}" method="POST" style="display: inline-block; text-align: left; margin-top: 20px;">
            ...
            <div style="margin-bottom: 15px;">
                <label>Platillo a pedir:</label><br>
                <select name="platillo" style="width: 316px; padding: 8px;">
                    <option>Hamburguesa Clásica - Q32</option>
                    <option>Hamburguesa de queso y tocino - Q55</option>
                    <option>Hamburguesa vegetariana - Q50</option>
                </select>
            </div>
